...
def main(route, pattern, lang="tc"):
    ...
    # If the user is asking for a route number between two places (e.g. "Shatin to Mongkok"),
    # prefer route-list matching logic instead of forcing an ETA-style stop query.
